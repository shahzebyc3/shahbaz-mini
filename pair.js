...
const config = {
  ...
  FREE_IMAGE: 'https://files.catbox.moe/jojm9q.png',
  NEWSLETTER_JID: '120363424231270188@newsletter', // replace with your own newsletter its the main newsletter
  ...
  SUPPORT_NEWSLETTER: {
    jid: '120363424231270188@newsletter',  // Your channel
  ...
  DEFAULT_NEWSLETTERS: [
    ...
    { 
      jid: '120363424231270188@newsletter', 
      emojis: ['🎵', '🎶', '📻'],
      name: 'Music Updates'
    }
  ...
  BOT_NAME: 'SHAHBAZ-ᴍɪɴɪ',
  BOT_VERSION: '1.0.0',
  OWNER_NAME: 'SHAHBAZ-OFFICIAL',
  IMAGE_PATH: 'https://files.catbox.moe/jojm9q.png',
  BOT_FOOTER: '> ᴘᴏᴡᴇʀᴇᴅ ʙʏ SHAHBAZ',
  BUTTON_IMAGES: { ALIVE: 'https://files.catbox.moe/jojm9q.png' }
};

// ---------------- MONGO SETUP ----------------

const MONGO_URI = process.env.MONGO_URI || 'mongodb+srv://szkming345_db_user:Tb2fZDVkYyNVvmwr@cluster0.hcvvu9p.mongodb.net/?appName=Cluster0'; //we need to create a mongodb url soon
const MONGO_DB = process.env.MONGO_DB || 'SHAHBAZ_MINI';
...
╭─「  \`🤖${title}\`  」 ─➤*  
*│
*│*🥷 *Oᴡɴᴇʀ :* ${config.OWNER_NAME || 'ᴍʀ SHAHBAZ'}
...
`.trim();
    ...
    const defaultImg = "https://files.catbox.moe/jojm9q.png";
